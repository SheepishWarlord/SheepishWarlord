...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_WOODS_CLEARING - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SPRING_OF_WISDOM - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DEWFORD_SHORES - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SECLUDED_RIVER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,    
    [MAPSEC_WEST_MT_CHIMNEY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TIMELESS_GROVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,    
};
