...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_SOFT_BOILED] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 10 : 10,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_SNORE] =
    {
        ...
        .effect = EFFECT_SNORE,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 40,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_GIGA_DRAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the damage inflicted."),
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 100 : 60,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 70 : 20,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SMELLING_SALTS] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 60,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_LUSTER_PURGE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = (B_UPDATED_MOVE_DATA >= GEN_9) ? 110 : 70,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_MUDDY_WATER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May lower accuracy."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 95,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_DOOM_DESIRE] =
    {
        ...
        .effect = EFFECT_FUTURE_SIGHT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 150 : 120,
        .type = TYPE_STEEL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 100 : 85,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_DRAGON_PULSE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "damage the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 95 : 90,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ENERGY_BALL] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 80,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_TECHNO_BLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "kind of Drive held."),
        .effect = EFFECT_CHANGE_TYPE_ON_ITEM,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 140 : 85,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_PARABOLIC_CHARGE] =
    {
        ...
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 90 : 50,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_FOES_AND_ALLY,
    ...
    [MOVE_MYSTICAL_FIRE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "fire. Lowers Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 95 : 65,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_OBLIVION_WING] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument = 100, // restores 75% HP instead of 50% HP
        .healingMove = B_HEAL_BLOCKING >= GEN_6,
        .contestEffect = CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
    ...
    [MOVE_ZIPPY_ZAP] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 110 : 50,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_GRASSY_GLIDE] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 70 : 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_BITTER_MALICE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Lowers the foe's Attack."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 95 : 60,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_BITTER_MEDICINE] =
    {
        .name = COMPOUND_STRING("Bitter Medicine"),
        .description = COMPOUND_STRING(
            "Explodes on foes, but\n"
            "restores ally's HP."),
        .effect = EFFECT_HIT_ENEMY_HEAL_ALLY,
    ...
    [MOVE_GALE_WIND] =
    {
        .name = COMPOUND_STRING("Gale Wind"),
        .description = COMPOUND_STRING(
            "Hits with a great gust of \n"
            "wind. Ups the user's Speed."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_STONESTORM] =
    {
        .name = COMPOUND_STRING("Stonestorm"),
        .description = COMPOUND_STRING(
                "The user generates rain while \n"
                "attacking with a large stone."),
        .effect = EFFECT_STONESTORM, //needs to be implemented
        .power = 60,
        .type = TYPE_ROCK,
        .accuracy = 0,
        .pp = 10,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},        
        .battleAnimScript = gBattleAnimMove_GMaxStonesurge, //Change to something probably
    },

    [MOVE_PETAL_GUARD] =
    {
        .name = COMPOUND_STRING("Petal Guard"),
        .description = COMPOUND_STRING(
            "Heals the user while also \n"
            "raising defenses."),
        .effect = EFFECT_SYNTHESIS,
        .power = 0,
        .type = TYPE_GRASS,
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEF_SPDEF_UP, //needs to be put in still
            .self = TRUE,
            .chance = 100,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
    ...
    [MOVE_TIDE_BITE] =
    {
        .name = COMPOUND_STRING("Tide Bite"),
        .description = COMPOUND_STRING(
            "The user bites with aquatic \n"
            "energy. Ups the user's Attack."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_THORN_CRASH] =
    {
        .name = COMPOUND_STRING("Thorn Crash"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MACH_STRIKE] =
    {
        .name = COMPOUND_STRING("Mach Strike"),
        .description = COMPOUND_STRING(
            "The user rushes to strike their\n"
            "opponent, usually goes first."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_ICY_WAVE] =
    {
        .name = COMPOUND_STRING("Icy Wave"),
        .description = COMPOUND_STRING(
            "Attacks with a great rush\n"
            "of ice-filled water."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 100,
        .type = TYPE_WATER,
    ...
    [MOVE_FROSTWIND] =
    {
        .name = COMPOUND_STRING("Frostwind"),
        .description = COMPOUND_STRING(
            "Inflicts frostbite on\n"
            "the target."),
        .effect = EFFECT_FROSTWIND, //needs to be implemented
        .power = 0,
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 10,
