...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_IRON_FIST },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_MOODY, ABILITY_NONE, ABILITY_COMPETITIVE },
    #else
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_INTIMIDATE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_FLARE_BOOST, ABILITY_UNBURDEN, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_SCRAPPY, ABILITY_SCRAPPY, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .abilities = { ABILITY_TRICKY_AURA, ABILITY_HEATPROOF, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_TRICKY_AURA, ABILITY_NONE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .abilities = { ABILITY_DRAGONS_MAW, ABILITY_NONE, ABILITY_ROUGH_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gible"),
        .cryId = CRY_GIBLE,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_INNER_FOCUS, ABILITY_JUSTIFIED },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_DRY_SKIN, ABILITY_DRY_SKIN, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRESSELIA] =
    {
        .baseHP        = 180,
        .baseAttack    = 70,
        .baseDefense   = P_UPDATED_STATS >= GEN_9 ? 120 : 120,
        .baseSpeed     = 85,
        .baseSpAttack  = 75,
        .baseSpDefense = P_UPDATED_STATS >= GEN_9 ? 130 : 130,
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                                \
    {                                                                               \
        ...
        .growthRate = GROWTH_SLOW,                                                  \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                  \
        .abilities = { ABILITY_PROTEAN, ABILITY_NONE, ABILITY_MULTITYPE },             \
        .bodyColor = BODY_COLOR_WHITE,                                              \
